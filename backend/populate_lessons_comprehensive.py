...
def create_quiz_questions(title, subject, num_questions=3):
    ...
    realistic_questions = {
        "Үлестірілген мәліметтер жүйелеріне кіріспе": [
            ...
            {
                "text": "Үлестірілген есептеулердің артықшылықтары қандай?",
                "type": "open_ended",
                "correct_answer": "Үлестірілген есептеулердің артықшылықтары: 1) Жоғары өнімділік; 2) Масштабталу қабілеті; 3) Жүйенің сенімділігін арттыру; 4) Ресурстарды тиімді пайдалану; 5) Кеңею мүмкіндігі.",
